...
Thanks for helping improve CrofAI for GitHub Copilot Chat.

## Before opening work

- Use [Discussions](https://github.com/grikomsn/crof-copilot-chat/discussions/categories/q-a) for setup and usage questions.
