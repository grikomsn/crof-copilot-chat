...
Security fixes target the latest version published on the [Visual Studio Marketplace](https://marketplace.visualstudio.com/items?itemName=grikomsn.crof-copilot-chat). Update to the latest release before reporting an issue that may already be fixed.
