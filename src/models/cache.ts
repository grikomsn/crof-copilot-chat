import type { CrofAIModelMetadata } from "./catalog";

export function parseCatalogSnapshots(value: unknown): Record<string, CrofAIModelMetadata[]> {
...
function validModel(value: unknown): value is CrofAIModelMetadata {
