 ...
 *
 * Strictly opt-in via `crofCopilot.inlineSuggestions`. The provider debounces
...
export class CrofInlineCompletionProvider implements vscode.InlineCompletionItemProvider {
  ...
  provideInlineCompletionItems(
    ...
    // (users can opt in via crofCopilot.inlineSuggestionsChatInput).
