 ...
 *
 * Suggestions are strictly opt-in: `crofCopilot.inlineSuggestions` defaults
 * to false and the provider checks the setting live on every request, so
 * toggling needs no reload.
 */

export const CONFIG_SECTION = "crofCopilot";
...
export const DEFAULT_INLINE_MODEL = "glm-5.3-flash";
